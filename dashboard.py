...
# v18+ — Strategic Outlook horizon-grid styling. Lives outside
# CUSTOM_CSS so the long projection-library section above stays
# readable; layout-only rules.
st.markdown(
    """
    <style>
      .horizon-grid {
      ...
      .horizon-row-cell strong { color: #f3f4f6; }
      .horizon-footer {
          margin-top: 0.55rem;
      ...
      .evidence-panel-row .ev-glyph {
          display: inline-block;
          width: 1.1rem;
          font-weight: 700;
      }
      .evidence-panel-row.ev-supporting .ev-glyph { color: #fca5a5; }
      .evidence-panel-row.ev-opposing  .ev-glyph { color: #86efac; }
      ...
      .evidence-panel-summary strong { color: #f3f4f6; }
      .projection-log-row {
          font-family: 'Courier New', monospace;
          font-size: 0.78rem;
          color: #9ca3af;
...
# ============================================================
# v18+ Strategic Outlook — horizon projection library
# ============================================================
# Hand-authored editorial content. NOT generated by an LLM and
# NOT mutable at runtime. Treat the strings as immutable text;
# the only changes that should ever happen here are quarterly
# editorial refreshes governed by the
# `scenario_horizon_projections_freshness` fact in
# EDITORIAL_FACTS. The library covers four scenarios × four
# horizons × ten metrics = 160 cells.

SCENARIO_HORIZON_PROJECTIONS = {
    "Tail Risk": {
        "30d": {
            "brent": "**Consumers:** Petrol and diesel prices climb 25–40% in the next month. **Businesses:** Transport-heavy operations face immediate margin pressure on every delivery.",
            "ttf": "**Consumers:** UK and EU gas bills jump sharply on the next billing cycle. **Businesses:** Industrial gas users hit by an immediate input-cost shock.",
            "urea": "**Consumers:** Bread, dairy, and meat prices begin to climb as fertiliser costs flow through over 8–12 weeks. **Businesses:** Food manufacturers face a 20–30% input-cost increase on cereals and protein.",
            "diesel_crack": "**Consumers:** Parcel delivery, taxi, and air freight surcharges within 30 days. **Businesses:** Freight invoices jump; some carriers add weekly fuel surcharges.",
            "hormuz": "**Consumers:** Goods sourced from the Middle East face delivery delays and visible price hikes. **Businesses:** Cape rerouting adds 10–14 days to crude and LNG shipments; build inventory buffers.",
            "panama": "**Consumers:** Imported electronics, furniture, and appliances see further price rises. **Businesses:** Container shipping rates from Asia climb again; pull forward Q3 orders.",
            "helium": "**Consumers:** New phones, computer storage, and MRI service face delays or price hikes within the quarter. **Businesses:** Audit any product BOM that touches helium-sealed drives or fab leak-test.",
            "co2_byproduct": "**Consumers:** Fizzy drinks, packaged meats, and frozen-food supply tighter on shelves. **Businesses:** Food producers needing food-grade CO2 face allocation cuts; line up alternates now.",
            "ai_storage": "**Consumers:** Cloud storage and AI service prices begin to rise. **Businesses:** Hard-drive lead times extend further; plan IT capex around 12–18 month delivery windows.",
            "oecd_inventory": "**Consumers:** Expect strategic-reserve releases; pump prices may temporarily ease before climbing further. **Businesses:** Lock in fuel hedges; assume Brent stays elevated through the quarter.",
        },
        "90d": {
            "brent": "**Consumers:** Petrol and diesel stay near record levels through summer; some governments declare energy emergencies. **Businesses:** Transport COGS up 30–40% sustained; price pass-through unavoidable on most goods.",
            "ttf": "**Consumers:** Winter heating bills set to be the highest in many years across the UK and EU. **Businesses:** Some energy-intensive industrial operations relocate or temporarily idle.",
            "urea": "**Consumers:** Cereal and meat prices step up another 10–15% as Spring 2027 planting decisions reshape supply. **Businesses:** Food manufacturers re-baseline pricing strategy for the 2027 financial year.",
            "diesel_crack": "**Consumers:** Delivery costs visibly higher on receipts; some retailers add explicit fuel surcharges. **Businesses:** Refiners ration product allocation; logistics firms re-negotiate contracts upward.",
            "hormuz": "**Consumers:** Knock-on supply gaps appear in unexpected categories (specialist food, electronics components). **Businesses:** Cascading attacks on alternate routes (Red Sea, subsea cables) disrupt wider trade.",
            "panama": "**Consumers:** Asian imports — toys, clothing, electronics — see another 15–20% price step. **Businesses:** Shipping costs from Asia roughly double from current levels; smaller carriers exit some routes.",
            "helium": "**Consumers:** MRI appointments delayed; some elective scans rescheduled to 2027. **Businesses:** Semiconductor production schedules slip 1–2 quarters; AI capex pipelines re-plan.",
            "co2_byproduct": "**Consumers:** Meat prices up 20–30% at retail; some elective hospital procedures deferred. **Businesses:** Food and beverage producers operate on rolling allocation; pre-position 60-day inventory.",
            "ai_storage": "**Consumers:** Cloud storage subscriptions re-priced; some AI services add usage caps. **Businesses:** AI capex pipelines re-baselined for 2027 instead of 2026.",
            "oecd_inventory": "**Consumers:** Fuel rationing visible in some import-dependent economies (notional purchase caps). **Businesses:** Strategic-reserve coordination becomes a live policy question; energy-import-dependent operations review continuity plans.",
        },
        "1y": {
            "brent": "**Consumers:** Fuel prices stay structurally elevated; household energy budgets permanently higher. **Businesses:** Recession deepens across EU and energy-importing economies; demand softening visible across sectors.",
            "ttf": "**Consumers:** Second winter without Russian pipeline gas; energy-efficiency investments pay back faster than ever. **Businesses:** Some industrial users permanently relocate or close energy-intensive lines.",
            "urea": "**Consumers:** Food prices remain elevated but ease slightly as fertiliser supply rebuilds. **Businesses:** China and India ramp domestic fertiliser production; global supply chains re-fragment by region.",
            "diesel_crack": "**Consumers:** Higher freight costs now permanently embedded in retail and grocery prices. **Businesses:** Logistics pricing resets to a structurally higher baseline; long-term contracts repriced.",
            "hormuz": "**Consumers:** Most goods still flowing but with persistent delays and premiums on Middle East-sourced inputs. **Businesses:** Partial transit recovery with naval escorts; shipping insurance permanently more expensive.",
            "panama": "**Consumers:** Asian-sourced goods carry a structural premium that doesn't fully unwind. **Businesses:** Slot pricing settles at multi-million-dollar levels; canal expansion announced but won't ship until 2028.",
            "helium": "**Consumers:** Helium-touching products (storage, medical scans, electronics) carry permanent premium pricing. **Businesses:** Alternative supply (East Africa, gas-stream recovery) ramps; BOM substitution becomes standard.",
            "co2_byproduct": "**Consumers:** Carbonated drinks and packaged meats more expensive; supply reliable but at a higher price baseline. **Businesses:** EU ammonia plants restart with subsidies; food-grade CO2 supply rebuilt around captured-emissions sources.",
            "ai_storage": "**Consumers:** Cloud storage and AI services priced higher than 2024 baseline; flash storage now standard in new devices. **Businesses:** Hard-drive lead times stabilise; AI compute economics permanently reset higher.",
            "oecd_inventory": "**Consumers:** Government fuel-tax structures may shift to fund strategic reserves. **Businesses:** Policy mandates higher minimum stocks going forward; storage capex requirements increase.",
        },
        "2y": {
            "brent": "**Consumers:** Fuel prices ease back from peak but stay above 2024 levels. **Businesses:** US and non-OPEC supply responds; EU industrial demand permanently lower from prior relocations.",
            "ttf": "**Consumers:** Gas bills stabilise at a new \"normal\" higher than pre-crisis but down from peak. **Businesses:** Rebuilt LNG infrastructure; EU industrial gas use 15–20% below pre-crisis.",
            "urea": "**Consumers:** Food prices ease but stay above 2024 baseline; some categories permanently higher. **Businesses:** Supply chains now more regional and less global; sourcing strategy permanently changed.",
            "diesel_crack": "**Consumers:** Freight costs normalise but the prior shock is now baked into consumer prices. **Businesses:** Refining margins back to historic norms; cost pass-through is permanent.",
            "hormuz": "**Consumers:** Goods flow normally again but with permanent insurance and escort premiums in pricing. **Businesses:** Strait fully reopened with permanent escort regime; routing economics permanently altered.",
            "panama": "**Consumers:** Asian imports return toward pre-crisis pricing as canal expansion ships. **Businesses:** Slot pricing returns toward pre-crisis levels; demand redistributes across Suez and Cape.",
            "helium": "**Consumers:** Helium-touching products still cost more than 2024 but supply is reliable. **Businesses:** Semiconductor industry has restructured BOM exposure around the constraint.",
            "co2_byproduct": "**Consumers:** Meat and beverage prices stabilise above pre-crisis baseline. **Businesses:** Food-grade CO2 supply diversified across point-source capture and captured-emission streams.",
            "ai_storage": "**Consumers:** Storage and AI services widely available again; pricing higher than 2024 but stable. **Businesses:** The 18-month allocation freeze has reset AI compute economics permanently higher.",
            "oecd_inventory": "**Consumers:** Pump prices stable; underlying tax structure reflects strategic-reserve mandates. **Businesses:** Reserves rebuilt to new policy-mandated minimum (~10% higher than pre-crisis).",
        },
    },
    "Base Case": {
        "30d": {
            "brent": "**Consumers:** Petrol and diesel prices stay near current elevated levels; no further spike. **Businesses:** Transport COGS hold at current premium; pass-through on most goods is now established.",
            "ttf": "**Consumers:** Gas bills stay high but stable; no fresh shock on the next billing cycle. **Businesses:** Industrial gas users have absorbed the prior spike; budgets re-baselined.",
            "urea": "**Consumers:** Food prices hold at current elevated levels; no further fertiliser-driven step-up. **Businesses:** Food manufacturers operating on the new input-cost baseline; margins compressed but stable.",
            "diesel_crack": "**Consumers:** Delivery surcharges still in place but not increasing further. **Businesses:** Freight contracts settle at the new pricing; weekly volatility eases.",
            "hormuz": "**Consumers:** Middle East-routed goods continue to face delays; deliveries slower but predictable. **Businesses:** Cape rerouting now standard for crude/LNG; 60-day inventory buffers should be fully positioned.",
            "panama": "**Consumers:** Asian imports priced at the current premium; no further Q3 hikes expected. **Businesses:** Container rates from Asia stabilise; carriers stop adding new surcharges.",
            "helium": "**Consumers:** Smartphones and computer storage prices stay high; MRI service availability stable but slow. **Businesses:** Allocation contracts firmed up; semiconductor production on revised slower schedules.",
            "co2_byproduct": "**Consumers:** Carbonated drinks and packaged meats stay tighter on shelves; supply unreliable but not collapsing. **Businesses:** Food and beverage producers operate on rolling allocation; alternates lined up.",
            "ai_storage": "**Consumers:** Cloud storage and AI service prices hold at recent re-pricing; no further hikes. **Businesses:** Hard-drive lead times stable around 9–12 months; capex pipelines adjusted to match.",
            "oecd_inventory": "**Consumers:** Pump prices high but stable; no government rationing announcements. **Businesses:** Strategic-reserve coordination ongoing; energy-import-dependent operations have continuity plans in place.",
        },
        "90d": {
            "brent": "**Consumers:** Petrol and diesel prices stay elevated through summer; budgets adjust. **Businesses:** Transport-cost premium fully embedded in retail prices; pass-through complete.",
            "ttf": "**Consumers:** Heating costs over winter materially higher than 2024 but no shock spikes. **Businesses:** Energy-intensive operations running at reduced margins; some defer non-essential capex.",
            "urea": "**Consumers:** Food prices hold at current elevated levels; some categories drift slightly higher seasonally. **Businesses:** Food manufacturers mid-way through Spring 2027 procurement planning at the new cost baseline.",
            "diesel_crack": "**Consumers:** Delivery surcharges visible but no longer rising; receipts more predictable. **Businesses:** Refining margins stable; logistics pricing now structurally higher than 2024 but settled.",
            "hormuz": "**Consumers:** Middle East-sourced inputs still delayed but supply chains adapted to it. **Businesses:** Naval escort regime semi-formalised; insurance premiums settle at higher baseline.",
            "panama": "**Consumers:** Asian imports carry the current premium; no further price steps from shipping. **Businesses:** Slot pricing stable; carriers run on revised route maps with Cape and Suez balancing the load.",
            "helium": "**Consumers:** New phones and storage products priced at the elevated baseline; MRI scheduling stable but slower than 2024. **Businesses:** Semiconductor capex pipelines re-baselined; AI infrastructure builds on revised schedules.",
            "co2_byproduct": "**Consumers:** Meat prices 15–20% above 2024; supply unreliable for some categories but no shortages. **Businesses:** Food and beverage producers running on long-term allocation contracts; pre-positioned inventory.",
            "ai_storage": "**Consumers:** Cloud and AI services widely available but priced higher than 2024. **Businesses:** AI capex continues but on slower delivery; some projects pushed into 2027 financial year.",
            "oecd_inventory": "**Consumers:** Pump prices stable; no rationing visible in major markets. **Businesses:** Strategic-reserve policy debate ongoing; some governments quietly increase mandated minimum stocks.",
        },
        "1y": {
            "brent": "**Consumers:** Fuel prices remain elevated but no shocks; household energy budgets settled at the new normal. **Businesses:** Sustained input-cost premium; pricing strategy fully reset for 2027.",
            "ttf": "**Consumers:** Energy bills materially higher than 2024 but stable and predictable. **Businesses:** Some energy-intensive operations have permanently reduced output or relocated lines.",
            "urea": "**Consumers:** Food prices ease slightly as supply stabilises; some categories permanently higher. **Businesses:** Regional fertiliser supply becomes the norm; sourcing strategies fully reset.",
            "diesel_crack": "**Consumers:** Higher delivery costs now permanently embedded; consumers no longer notice them as surcharges. **Businesses:** Long-term freight contracts repriced; the new baseline holds.",
            "hormuz": "**Consumers:** Most goods flow normally with persistent premiums on Middle East-sourced inputs. **Businesses:** Insurance and routing economics permanently more expensive; baked into product pricing.",
            "panama": "**Consumers:** Asian-sourced goods carry a structural premium that doesn't fully unwind. **Businesses:** Slot pricing settles at current levels; canal expansion announced but won't ship until 2028.",
            "helium": "**Consumers:** Helium-touching products (storage, medical scans) carry permanent premium pricing. **Businesses:** BOM substitution complete on most lines; remaining helium dependency tightly managed.",
            "co2_byproduct": "**Consumers:** Carbonated drinks and packaged meats more expensive; supply reliable at the higher baseline. **Businesses:** Captured-emissions CO2 supply chain established; food and beverage producers diversified across sources.",
            "ai_storage": "**Consumers:** AI services and cloud storage priced higher than 2024 but supply reliable. **Businesses:** Hard-drive lead times stabilise; AI compute economics permanently reset.",
            "oecd_inventory": "**Consumers:** Government fuel-tax structures may shift to fund higher reserves. **Businesses:** Policy mandates higher minimum stocks; storage capex requirements increase across the industry.",
        },
        "2y": {
            "brent": "**Consumers:** Fuel prices stable at the new normal; some easing as US and non-OPEC supply responds. **Businesses:** Cost structure fully reset; demand patterns reflect the higher baseline.",
            "ttf": "**Consumers:** Gas bills stable; energy efficiency investments now standard in households. **Businesses:** Rebuilt LNG infrastructure means reliable supply, but at higher unit cost than 2024.",
            "urea": "**Consumers:** Food prices ease slightly but stay above 2024 baseline. **Businesses:** Supply chains permanently more regional; sourcing strategy stable on the new map.",
            "diesel_crack": "**Consumers:** Freight costs normalised but baked into all prices. **Businesses:** Refining margins back to historic norms; cost pass-through is permanent.",
            "hormuz": "**Consumers:** Goods flow normally with permanent insurance premiums in pricing. **Businesses:** Naval escort regime now permanent; routing economics permanently altered.",
            "panama": "**Consumers:** Asian imports return toward pre-crisis pricing as canal expansion ships. **Businesses:** Slot pricing eases as capacity comes online; demand redistributes.",
            "helium": "**Consumers:** Helium-touching products still cost more than 2024 but supply is reliable. **Businesses:** Semiconductor industry has restructured BOM exposure; new alternative supply (East Africa) operating at scale.",
            "co2_byproduct": "**Consumers:** Meat and beverage prices stable above pre-crisis baseline. **Businesses:** Food-grade CO2 supply diversified and reliable; risk premium permanently embedded.",
            "ai_storage": "**Consumers:** Storage and AI services widely available; pricing higher than 2024 but stable. **Businesses:** Hardware constraints fully integrated into capex planning; flash storage now default.",
            "oecd_inventory": "**Consumers:** Pump prices stable; tax structure reflects strategic-reserve mandates. **Businesses:** Reserves rebuilt to new policy-mandated minimum (~5–10% higher than pre-crisis).",
        },
    },
    "Slow Normalization": {
        "30d": {
            "brent": "**Consumers:** Petrol and diesel prices begin to ease but stay above 2024 levels. **Businesses:** Transport COGS premium narrows by 5–10%; pricing strategy adjusts but doesn't reverse.",
            "ttf": "**Consumers:** Gas bills stop rising; some suppliers offer modest fixed-rate deals again. **Businesses:** Industrial gas users see input costs stabilise; planning horizon extends back out.",
            "urea": "**Consumers:** Food prices flatten; no further fertiliser-driven step-ups expected. **Businesses:** Food manufacturers see input-cost pressure ease but margins remain compressed.",
            "diesel_crack": "**Consumers:** Delivery surcharges hold steady; some carriers begin removing seasonal additions. **Businesses:** Refining margins normalise gradually; freight contracts renegotiated downward in some lanes.",
            "hormuz": "**Consumers:** Shipping delays on Middle East-routed goods begin to ease modestly. **Businesses:** Transit count picks up toward 30+ ships/day; Cape rerouting still standard but pressure off the alternates.",
            "panama": "**Consumers:** Asian imports begin to ease in price; some categories see modest reductions. **Businesses:** Container rates from Asia tick down 5–10%; carriers withdraw the most aggressive surcharges.",
            "helium": "**Consumers:** New phones and storage products still expensive but allocation eases; MRI booking windows narrow. **Businesses:** First signs of allocation flexibility from major suppliers; substitution work continues but feels less urgent.",
            "co2_byproduct": "**Consumers:** Carbonated drinks and packaged-meat shelves restock; supply gaps narrow. **Businesses:** EU ammonia plants signal capacity restart; food and beverage producers see allocation ease.",
            "ai_storage": "**Consumers:** Cloud storage prices stable; AI service availability improves. **Businesses:** Hard-drive lead times narrow toward 6–9 months; capex pipelines get more predictable.",
            "oecd_inventory": "**Consumers:** Pump prices ease modestly; no rationing concerns. **Businesses:** Strategic-reserve releases continue but at slower pace; inventory rebuild begins.",
        },
        "90d": {
            "brent": "**Consumers:** Petrol and diesel prices materially below peak but still above 2024; budgets ease but don't return. **Businesses:** Transport-cost premium narrowing further; pricing pass-through partially reversed.",
            "ttf": "**Consumers:** Winter heating bills high but more predictable; suppliers offer longer fixed-rate plans. **Businesses:** Industrial gas users plan capex with more confidence; some idled lines restart.",
            "urea": "**Consumers:** Food prices begin to ease; some categories partially unwind earlier hikes. **Businesses:** Spring 2027 procurement at meaningfully lower prices than feared; margins recover modestly.",
            "diesel_crack": "**Consumers:** Delivery surcharges fall back; receipts simpler. **Businesses:** Logistics pricing eases; long-term contracts renegotiated to reflect lower baseline.",
            "hormuz": "**Consumers:** Middle East-sourced supply normalises; delivery times improve toward pre-crisis range. **Businesses:** Transit count toward 40+ ships/day; some carriers route directly through Strait again.",
            "panama": "**Consumers:** Asian imports priced 10–15% above 2024 baseline but no longer rising. **Businesses:** Slot pricing eases toward $200–300K range; carriers re-balance routes.",
            "helium": "**Consumers:** Helium-touching products still elevated but allocation pressure off; MRI scheduling near-normal. **Businesses:** Semiconductor production schedules recover; AI capex pipelines retighten timelines.",
            "co2_byproduct": "**Consumers:** Carbonated drinks and packaged-meat supply reliable again; prices ease modestly. **Businesses:** EU ammonia capacity climbs back toward 50%; food and beverage producers reduce safety-stock levels.",
            "ai_storage": "**Consumers:** Cloud storage and AI services priced toward 2024 baseline; new device availability normalises. **Businesses:** Hard-drive lead times narrow further; AI capex pipelines accelerate again.",
            "oecd_inventory": "**Consumers:** Pump prices ease toward more familiar ranges; rationing concerns recede. **Businesses:** Strategic reserves rebuild on track; energy-import-dependent operations relax continuity plans.",
        },
        "1y": {
            "brent": "**Consumers:** Fuel prices materially closer to 2024 baseline but still 10–15% above. **Businesses:** Cost structure approaches a new stable baseline; pricing strategies partially unwound.",
            "ttf": "**Consumers:** Energy bills meaningfully easier than peak; second winter much less painful. **Businesses:** Some previously idled industrial lines restart; capex returns to growth posture.",
            "urea": "**Consumers:** Food prices ease toward 2024 levels; some categories permanently slightly higher. **Businesses:** Fertiliser supply rebuilds; sourcing strategies stabilise on a partially restructured map.",
            "diesel_crack": "**Consumers:** Freight costs ease meaningfully; receipts return to familiar shape. **Businesses:** Refining margins back toward historic norms; logistics pricing partially unwinds prior shock.",
            "hormuz": "**Consumers:** Shipping flows largely normal; some persistent insurance premiums in pricing. **Businesses:** Transit count near pre-crisis range; naval escort regime scaling back.",
            "panama": "**Consumers:** Asian imports priced near 2024 baseline; small premium persists. **Businesses:** Slot pricing back toward $150–200K range; canal expansion accelerated to ship by mid-2028.",
            "helium": "**Consumers:** Helium-touching products priced near 2024 baseline; MRI service fully normalised. **Businesses:** Alternative supply (East Africa) on track; semiconductor industry has restructured but pressure off.",
            "co2_byproduct": "**Consumers:** Food-grade CO2 supply reliable; prices ease toward 2024. **Businesses:** EU ammonia at 70%+ capacity; food and beverage producers operating normally with diversified sources.",
            "ai_storage": "**Consumers:** Storage and AI services priced near 2024 baseline; product availability normal. **Businesses:** Hard-drive lead times back to pre-crisis range; AI capex back on accelerated trajectory.",
            "oecd_inventory": "**Consumers:** Pump prices stabilise near familiar levels; tax structure may reflect higher mandated reserves. **Businesses:** Reserves rebuilt to slightly elevated baseline; storage capex requirements modestly higher.",
        },
        "2y": {
            "brent": "**Consumers:** Fuel prices close to 2024 norms; minor premium persists. **Businesses:** Cost structure largely reset to pre-crisis baseline with small structural premium.",
            "ttf": "**Consumers:** Gas bills near 2024 levels; energy efficiency investments pay back faster but no longer mandatory. **Businesses:** Industrial gas demand recovers; some efficiency gains permanent.",
            "urea": "**Consumers:** Food prices essentially back to 2024 baseline. **Businesses:** Supply chains partially regional but not fragmented; sourcing flexibility regained.",
            "diesel_crack": "**Consumers:** Freight costs back to 2024 norms; consumers no longer notice the prior shock. **Businesses:** Refining margins normal; logistics pricing fully reset.",
            "hormuz": "**Consumers:** Shipping flows entirely normal; minor insurance premium baked in. **Businesses:** Transit at pre-crisis levels; escort regime scaled back to advisory.",
            "panama": "**Consumers:** Asian imports back to 2024 baseline pricing. **Businesses:** Slot pricing at pre-crisis range; canal expansion now operational.",
            "helium": "**Consumers:** Helium-touching products back to pre-crisis pricing. **Businesses:** Industry has gained alternative supply paths; resilience structurally improved.",
            "co2_byproduct": "**Consumers:** Food and beverage prices fully normalised. **Businesses:** Food-grade CO2 supply diversified across multiple sources; risk reduced vs pre-crisis structure.",
            "ai_storage": "**Consumers:** Storage and AI services priced normally; product availability robust. **Businesses:** Hard-drive lead times at pre-crisis norms; AI capex on full growth trajectory.",
            "oecd_inventory": "**Consumers:** Pump prices normal; reserve mandates reflected in tax structure but invisible to consumers. **Businesses:** Reserves at slightly higher policy-mandated minimum (~5% above pre-crisis).",
        },
    },
    "Best Case": {
        "30d": {
            "brent": "**Consumers:** Petrol and diesel prices fall sharply; pump price drops visible week to week. **Businesses:** Transport COGS narrows toward 2024 norms; pricing pass-through unwinds rapidly.",
            "ttf": "**Consumers:** Gas bills drop on the next billing cycle; some suppliers offer aggressive fixed-rate deals. **Businesses:** Industrial gas users see input costs ease quickly; previously idled lines plan restart.",
            "urea": "**Consumers:** Food price increases halt; some categories begin retracing earlier hikes. **Businesses:** Food manufacturers see input-cost relief; margin recovery begins immediately.",
            "diesel_crack": "**Consumers:** Delivery surcharges drop or disappear; receipts simpler again. **Businesses:** Refining margins normalise quickly; freight contracts renegotiated downward.",
            "hormuz": "**Consumers:** Middle East-routed goods return to normal delivery times; supply gaps close. **Businesses:** Transit count climbs toward 50+ ships/day; Cape rerouting unwinds; insurance premiums begin falling.",
            "panama": "**Consumers:** Asian imports begin to ease in price across most categories. **Businesses:** Container rates from Asia drop noticeably; carriers withdraw surcharges en masse.",
            "helium": "**Consumers:** Allocation pressure releases; new phones and storage availability improves visibly. **Businesses:** Allocation flexibility returns from major suppliers; substitution work pauses.",
            "co2_byproduct": "**Consumers:** Carbonated drinks and packaged-meat shelves restock fully; supply normal. **Businesses:** EU ammonia plants ramp capacity; food and beverage producers reduce safety-stock levels.",
            "ai_storage": "**Consumers:** Cloud storage and AI service prices begin to ease; product availability improves. **Businesses:** Hard-drive lead times narrow rapidly; capex pipelines accelerate.",
            "oecd_inventory": "**Consumers:** Pump prices drop visibly; rationing concerns evaporate. **Businesses:** Strategic-reserve releases ease off; inventory rebuild accelerates.",
        },
        "90d": {
            "brent": "**Consumers:** Petrol and diesel prices materially close to 2024 baseline; minor premium remains. **Businesses:** Cost structure largely reset; pricing strategy returns to pre-crisis posture.",
            "ttf": "**Consumers:** Heating bills back to within 10–15% of 2024 norms; some categories priced normally. **Businesses:** Industrial gas users plan capex with full confidence; previously idled lines restart.",
            "urea": "**Consumers:** Food prices ease materially; many categories back to 2024 levels or close. **Businesses:** Spring 2027 procurement at near-2024 prices; margin recovery substantial.",
            "diesel_crack": "**Consumers:** Delivery costs back to familiar levels. **Businesses:** Refining margins back to historic norms; logistics pricing unwinds prior shock.",
            "hormuz": "**Consumers:** Shipping flows fully normal; insurance premiums on Middle East routes ease. **Businesses:** Transit at pre-crisis range; naval escort regime scaled back.",
            "panama": "**Consumers:** Asian imports priced near 2024 baseline; small premium persists. **Businesses:** Slot pricing back toward $150–200K range; carriers fully on standard route maps.",
            "helium": "**Consumers:** Helium-touching products priced near 2024 baseline; MRI service fully normalised. **Businesses:** Semiconductor production fully recovered; AI capex pipelines accelerate.",
            "co2_byproduct": "**Consumers:** Carbonated drinks and packaged meats priced near 2024; supply fully reliable. **Businesses:** EU ammonia capacity at 80%+; food and beverage producers operate normally.",
            "ai_storage": "**Consumers:** Storage and AI services priced near 2024 baseline; product availability normal. **Businesses:** Hard-drive lead times approach pre-crisis range; AI capex on full growth trajectory.",
            "oecd_inventory": "**Consumers:** Pump prices stable near 2024 levels. **Businesses:** Strategic reserves rebuilding ahead of mandated minimums; energy-import-dependent operations normalise.",
        },
        "1y": {
            "brent": "**Consumers:** Fuel prices fully back to 2024 norms. **Businesses:** Cost structure fully normalised; pricing strategy at pre-crisis baseline.",
            "ttf": "**Consumers:** Energy bills at 2024 levels; energy efficiency investments pay back faster but not mandatory. **Businesses:** Industrial gas demand fully recovered; some efficiency gains permanent and welcome.",
            "urea": "**Consumers:** Food prices back to 2024 norms; some easing in seasonally volatile categories. **Businesses:** Fertiliser supply fully restored; sourcing flexibility regained across regions.",
            "diesel_crack": "**Consumers:** Freight costs back to 2024; consumers no longer notice the prior shock at all. **Businesses:** Refining margins normal; logistics pricing fully reset.",
            "hormuz": "**Consumers:** Shipping flows entirely normal; small insurance premium baked in but invisible. **Businesses:** Transit at pre-crisis levels; escort regime scaled back to advisory monitoring.",
            "panama": "**Consumers:** Asian imports at 2024 baseline pricing. **Businesses:** Slot pricing fully normalised; canal expansion pipeline accelerated to ship by mid-2028.",
            "helium": "**Consumers:** Helium-touching products at pre-crisis pricing. **Businesses:** Industry has gained alternative supply paths; resilience structurally improved with no cost penalty.",
            "co2_byproduct": "**Consumers:** Food and beverage prices fully normalised. **Businesses:** Food-grade CO2 supply diversified across multiple sources; risk reduced vs pre-crisis structure.",
            "ai_storage": "**Consumers:** Storage and AI services priced normally; product availability robust. **Businesses:** Hard-drive lead times at pre-crisis norms; AI capex on accelerated trajectory thanks to caught-up demand.",
            "oecd_inventory": "**Consumers:** Pump prices normal; reserve mandates invisible to consumers. **Businesses:** Reserves at slightly higher policy-mandated minimum (~3–5% above pre-crisis).",
        },
        "2y": {
            "brent": "**Consumers:** Fuel prices stable at 2024 norms. **Businesses:** Cost structure at pre-crisis baseline; demand patterns fully recovered.",
            "ttf": "**Consumers:** Gas bills at 2024 levels; energy efficiency investments routine but not pressured. **Businesses:** Industrial gas demand fully restored; some efficiency gains permanent.",
            "urea": "**Consumers:** Food prices stable at 2024 norms. **Businesses:** Supply chains slightly more diversified than pre-crisis but functionally similar.",
            "diesel_crack": "**Consumers:** Freight costs normal. **Businesses:** Refining margins normal; logistics pricing fully reset.",
            "hormuz": "**Consumers:** Shipping flows entirely normal. **Businesses:** Transit at pre-crisis levels; minor insurance premium remains as systemic risk pricing.",
            "panama": "**Consumers:** Asian imports at 2024 baseline pricing. **Businesses:** Slot pricing at pre-crisis range; canal expansion now operational.",
            "helium": "**Consumers:** Helium-touching products at pre-crisis pricing. **Businesses:** Industry now supplied from more diverse sources; resilience structurally better than 2024.",
            "co2_byproduct": "**Consumers:** Food and beverage prices fully normalised. **Businesses:** Food-grade CO2 supply diversified; risk lower than pre-crisis structure.",
            "ai_storage": "**Consumers:** Storage and AI services priced normally. **Businesses:** Hardware constraints gone; AI capex at accelerated trajectory.",
            "oecd_inventory": "**Consumers:** Pump prices normal; tax structure reflects modest reserve mandate. **Businesses:** Reserves at slightly higher baseline; storage capex requirements modestly higher than pre-crisis.",
        },
    },
}

SCENARIO_HORIZON_FOOTERS = {
    "Tail Risk": {
        "30d": "Fill heating oil and fuel tanks now. Lock in fixed-rate energy contracts before the next billing cycle. Pull forward Asia-sourced orders that would normally ship in late summer. Defer non-essential electronics purchases.",
        "90d": "Negotiate forward energy hedges where possible. Stock 60-day pantry buffers (households) or critical-SKU buffers (businesses). Review supplier contracts for force-majeure and pass-through clauses. If considering major IT or medical-equipment purchases, decide now or wait until 2027.",
        "1y": "Restructure long-term supplier contracts around the new cost baseline. Plan capital expenditure on a longer cycle. Households should expect 8–15% cumulative inflation on essentials; review savings buffers and fixed-rate borrowing now.",
        "2y": "Treat the new cost baseline as permanent — don't budget around a return to 2024 prices. Diversify supply geography wherever possible. Households should structurally adjust energy efficiency and consumption patterns; the savings compound over time.",
    },
    "Base Case": {
        "30d": "Stop reacting; start adjusting. Lock the energy hedges and supplier contracts at current rates — they probably won't get cheaper soon. Households and businesses should treat the current cost level as the new normal for at least the next quarter.",
        "90d": "Plan for elevated costs through year-end with confidence; this is the operating environment. Renegotiate annual contracts at the new baseline. Households should review fixed vs variable expenses and pad savings buffers. Businesses should focus on operational efficiency rather than waiting for prices to fall.",
        "1y": "Treat current price levels as permanent for planning purposes. Households should expect 4–8% cumulative inflation on essentials over the year — meaningfully above 2024 norms but not crisis-level. Businesses should focus on operational efficiency, geographic supply diversification, and locking long-term contracts rather than waiting for relief.",
        "2y": "The current cost environment is the new baseline; budget accordingly. Households should treat energy efficiency and consumption discipline as permanent habits. Businesses should diversify supply geography, lock long-term contracts where possible, and accept that some categories of input cost will not return to 2024 levels.",
    },
    "Slow Normalization": {
        "30d": "Don't unwind hedges yet — current pricing improvements are real but fragile. Lock in any forward contracts at the new lower levels, but assume some volatility before the trend confirms. Households can defer urgent fuel-tank top-ups but shouldn't assume prices return to 2024 norms.",
        "90d": "Begin unwinding the most expensive emergency hedges, but keep core forward contracts in place. Households should still budget for elevated essentials but can plan major purchases with more confidence. Businesses should extend planning horizons and start booking 2027 procurement at the improving prices.",
        "1y": "Treat the easing as real but not complete; budget for a 3–6% premium above 2024 norms on essentials. Households can return to long-term financial planning with more confidence. Businesses should rebalance toward growth posture but keep diversified supply geography and the most strategic long-term contracts.",
        "2y": "Treat the recovery as essentially complete with minor permanent residuals. Households can budget around 2024 norms with small upward adjustments. Businesses should retain the supply diversification gained during the crisis as resilience insurance, but otherwise return to pre-crisis operating posture.",
    },
    "Best Case": {
        "30d": "Don't fully unwind hedges yet — recovery momentum is real but watch for whipsaw. Lock the lower forward prices into long-term contracts. Households can defer expensive emergency purchases. Businesses should plan for a normal 2026 second-half operating environment but keep some defensive structure in place.",
        "90d": "Begin unwinding emergency hedges in measured tranches. Households can return to normal financial planning. Businesses should rebalance toward growth posture but retain at least one supply diversification gain (contracts, inventory, alternates) as resilience insurance for the next disruption.",
        "1y": "Treat the recovery as essentially complete with minor permanent residuals. Households can budget around 2024 norms. Businesses should retain the supply diversification and resilience gains from the crisis as low-cost insurance, but otherwise return to pre-crisis growth posture.",
        "2y": "Treat the recovery as complete. Most operating decisions can return to pre-crisis frameworks. The supply diversification gained during the crisis is the most valuable permanent residual — keep it. Households can budget around 2024 norms with confidence.",
    },
}

# Editorial inputs that justified the percentage ranges in the
# cell text. Logged in the Source Dump for auditability — never
# substituted into rendered cells. No .format() on the strings.
SCENARIO_PROJECTION_TARGETS = {
    "Tail Risk": {
        "tail_brent_30d_low": 130, "tail_brent_30d_high": 145,
        "tail_brent_90d_low": 140, "tail_brent_90d_high": 165,
        "tail_brent_1y_low":  130, "tail_brent_1y_high":  150,
        "tail_brent_2y_low":  100, "tail_brent_2y_high":  120,
        "tail_ttf_30d": 70,  "tail_ttf_90d": 90,
        "tail_ttf_1y":  75,  "tail_ttf_2y":  55,
        "tail_urea_30d": 800, "tail_urea_90d": 950,
        "tail_urea_1y":  750, "tail_urea_2y":  550,
        "tail_diesel_30d": 80, "tail_diesel_90d": 95,
        "tail_diesel_1y":  70, "tail_diesel_2y":  40,
        "tail_panama_30d": "1.5", "tail_panama_90d": "3.0",
        "tail_panama_1y":  "2.0", "tail_panama_2y":  "0.8",
        "tail_helium_30d": 1500, "tail_helium_90d": 2200,
        "tail_helium_1y":  1500, "tail_helium_2y":  900,
        "tail_ammonia_30d": 30, "tail_ammonia_90d": 22,
        "tail_ammonia_1y":  45, "tail_ammonia_2y":  70,
        "tail_storage_30d_months": 14, "tail_storage_90d_months": 22,
        "tail_storage_1y_months":  18, "tail_storage_2y_months":  10,
    },
    "Base Case": {
        "base_brent_30d_low": 100, "base_brent_30d_high": 115,
        "base_brent_90d_low": 100, "base_brent_90d_high": 115,
        "base_brent_1y_low":   95, "base_brent_1y_high":  110,
        "base_brent_2y_low":   85, "base_brent_2y_high":  100,
        "base_ttf_30d": 50,  "base_ttf_90d": 55,
        "base_ttf_1y":  50,  "base_ttf_2y":  45,
        "base_urea_30d": 680, "base_urea_90d": 650,
        "base_urea_1y":  600, "base_urea_2y":  500,
        "base_diesel_30d": 65, "base_diesel_90d": 60,
        "base_diesel_1y":  50, "base_diesel_2y":  35,
        "base_panama_30d": "0.4", "base_panama_90d": "0.5",
        "base_panama_1y":  "0.4", "base_panama_2y":  "0.2",
        "base_helium_30d": 1100, "base_helium_90d": 1100,
        "base_helium_1y":  1000, "base_helium_2y":  700,
        "base_ammonia_30d": 35, "base_ammonia_90d": 38,
        "base_ammonia_1y":  50, "base_ammonia_2y":  75,
        "base_storage_30d_months": 9,  "base_storage_90d_months": 10,
        "base_storage_1y_months":  8,  "base_storage_2y_months":  6,
    },
    "Slow Normalization": {
        "slow_brent_30d_low":  95, "slow_brent_30d_high": 110,
        "slow_brent_90d_low":  90, "slow_brent_90d_high": 105,
        "slow_brent_1y_low":   85, "slow_brent_1y_high":   95,
        "slow_brent_2y_low":   75, "slow_brent_2y_high":   85,
        "slow_ttf_30d": 48,  "slow_ttf_90d": 45,
        "slow_ttf_1y":  40,  "slow_ttf_2y":  35,
        "slow_urea_30d": 650, "slow_urea_90d": 580,
        "slow_urea_1y":  500, "slow_urea_2y":  420,
        "slow_diesel_30d": 55, "slow_diesel_90d": 45,
        "slow_diesel_1y":  35, "slow_diesel_2y":  25,
        "slow_panama_30d": "0.35", "slow_panama_90d": "0.25",
        "slow_panama_1y":  "0.18", "slow_panama_2y":  "0.14",
        "slow_helium_30d": 1000, "slow_helium_90d": 850,
        "slow_helium_1y":  650,  "slow_helium_2y":  500,
        "slow_ammonia_30d": 40, "slow_ammonia_90d": 50,
        "slow_ammonia_1y":  70, "slow_ammonia_2y":  85,
        "slow_storage_30d_months": 8, "slow_storage_90d_months": 6,
        "slow_storage_1y_months":  4, "slow_storage_2y_months":  3,
    },
    "Best Case": {
        "best_brent_30d_low":  85, "best_brent_30d_high":  95,
        "best_brent_90d_low":  78, "best_brent_90d_high":  88,
        "best_brent_1y_low":   72, "best_brent_1y_high":   82,
        "best_brent_2y_low":   70, "best_brent_2y_high":   80,
        "best_ttf_30d": 42, "best_ttf_90d": 38,
        "best_ttf_1y":  35, "best_ttf_2y":  32,
        "best_urea_30d": 580, "best_urea_90d": 510,
        "best_urea_1y":  470, "best_urea_2y":  450,
        "best_diesel_30d": 45, "best_diesel_90d": 32,
        "best_diesel_1y":  22, "best_diesel_2y":  18,
        "best_panama_30d": "0.28", "best_panama_90d": "0.18",
        "best_panama_1y":  "0.14", "best_panama_2y":  "0.13",
        "best_helium_30d": 850, "best_helium_90d": 600,
        "best_helium_1y":  450, "best_helium_2y":  400,
        "best_ammonia_30d": 50, "best_ammonia_90d": 75,
        "best_ammonia_1y":  90, "best_ammonia_2y":  95,
        "best_storage_30d_months": 6, "best_storage_90d_months": 4,
        "best_storage_1y_months":  3, "best_storage_2y_months":  2,
    },
}

# Display order for the 10 metric rows in each tab. Same across
# all scenarios and horizons; the cell content varies but the
# row sequence stays stable so the eye learns the layout.
SCENARIO_HORIZON_METRIC_ORDER = [
    "brent", "ttf", "urea", "diesel_crack",
    "hormuz", "panama",
    "helium", "co2_byproduct", "ai_storage", "oecd_inventory",
]

SCENARIO_HORIZON_METRIC_LABELS = {
    "brent":          "Brent Crude",
    "ttf":            "TTF Gas",
    "urea":           "Urea Spot",
    "diesel_crack":   "Diesel Crack",
    "hormuz":         "Hormuz Transits",
    "panama":         "Panama Slot",
    "helium":         "Industrial Helium",
    "co2_byproduct":  "Industrial CO2",
    "ai_storage":     "AI Storage / HDD",
    "oecd_inventory": "OECD Oil Inventory",
}

# Cluster colour-coding for the metric label badge. Amber for
# the Commodity cluster, teal for Logistics chokepoints, red
# for Buffers / structural-stress signals.
SCENARIO_HORIZON_CLUSTER_COLORS = {
    "brent":          "#fbbf24",
    "ttf":            "#fbbf24",
    "urea":           "#fbbf24",
    "diesel_crack":   "#fbbf24",
    ...
    "panama":         "#5eead4",
    "helium":         "#fca5a5",
    "co2_byproduct":  "#fca5a5",
    "ai_storage":     "#fca5a5",
    "oecd_inventory": "#fca5a5",
}

SCENARIO_HORIZON_TAB_LABELS = [
    ("30d", "30-DAY"),
    ("90d", "90-DAY"),
    ("1y",  "1-YEAR"),
    ("2y",  "2-YEAR"),
...
CAPTION_TEXTS = {
    ...
    "helium": {
        ...
        # Warning tier — force majeure persists past boil-off
        # threshold but smart-money equity proxy (APD) is not
        # pricing in fab collapse yet; Reuters reports Korean fab
        # inventory through ~June. This is the active state under
        # the helium-revert-and-resoften softening.
        "warning":  "Force majeure persists. Korean fab reserves "
                    "est. through ~June (Reuters); Taiwan buffered "
                    "by recycling. Spot at $800 is 2.6× baseline. "
                    "APD ticker NOMINAL — leading signal, watch "
                    "for inflection.",
...
EDITORIAL_FACTS = {
    ...
    # helium-revert-and-resoften-2026-05-04 — fallback fact mirroring
    # the Panama pattern. Anchors the helium spot price + tile
    # editorial framing under the Option B softening (FORCE MAJEURE
    # ACTIVE, not EXHAUSTED). Fires only when the live Perplexity
    # fetch returns None for helium_spot_price_mcf; if a live number
    # is present the live data wins. Either way the source-dump
    # records this entry so the audit trail captures the editorial
    # pin. The recovery overlay in helium_exhausted() now uses the
    # rebased $400 threshold, so a fact value of $800 no longer
    # mis-classifies the gate as recovered.
    "helium_spot_price_mcf": {
        "value": 800.0,
        "set_on": date(2026, 5, 4),
        "set_by": "helium-revert-and-resoften-2026-05-04 brief",
        "rationale":
            ...
            "Moody's helium outlook (April 22) — 2.6× the pre-war "
            "$300 baseline. Anchors the tile editorial framing "
            "while Reuters reports Korean fab inventory through "
            "~June and APD equity ticker remains nominal — fab-"
            "floor exhaustion is not yet evidenced in smart-money "
            "signals. Linde and Air Products signing new long-"
            "term agreements with Samsung / SK Hynix is "
            "procurement diversification toward US sources, NOT "
            "Qatari flow restoration.",
        "primary_source":
    ...
    # When this fact's expires_on passes, the dashboard renders
    # a yellow "calibration may have drifted" banner above the
    # Strategic Outlook section. The marker is a pure flag —
    # no target_intel_key, no module-global mutation; the
    # render layer reads expires_on directly.
    "scenario_horizon_projections_freshness": {
        "value": True,
        "set_on": date(2026, 5, 1),
        "set_by": "v18 brief — initial library authoring",
        "rationale": (
            "The four-scenario horizon projection library "
            "(SCENARIO_HORIZON_PROJECTIONS, 160 cells) was "
            "hand-authored as of May 1, 2026. The library "
            "needs quarterly review for calibration drift; "
            "this fact governs whether the library is "
            "considered current. When expired, the dashboard "
            "displays a refresh-needed banner above the "
            "Strategic Outlook section."
        ),
        "primary_source": "v18 editorial pass",
        "expires_on": date(2026, 8, 1),  # 90-day quarterly window
    },
}


def is_scenario_library_fresh(today=None):
    """v18+ — return True when the editorial library's
    `scenario_horizon_projections_freshness` fact is still
    within its 90-day quarterly window. Used by the render
    layer to decide whether to show the calibration-drift
    banner above the Strategic Outlook section."""
    fact = EDITORIAL_FACTS.get(
        "scenario_horizon_projections_freshness",
    )
    if not fact:
        return True
...
def adjust_probabilities(prices: dict, intel: dict | None = None,
                         equity_changes: dict | None = None,
                         return_evidence: bool = False):
    """v18+ — backwards-compatible signature.

    Default behaviour returns just the probability dict (every
    existing call site stays valid). When `return_evidence=True`
    the return value becomes a 2-tuple `(probs, evidence)`, where
    `evidence` is a list of dicts — one record per rule that fired,
    in fire order. The math is exactly the same as before; only
    the audit trail is new.

    Each evidence record looks like:
        {
            "rule_id":         <stable identifier>,
            "human_readable":  <one-line explanation>,
            "scenario_impact": {<scenario>: <signed_pts>, ...},
            "data_value":      <raw input that triggered the rule>,
            "data_unit":       <units on data_value>,
            "rule_threshold":  <the threshold the rule encoded>,
        }
    The Malacca CRITICAL hard-override and the equity-proxy
    aggregator both surface composite records so the panel can
    explain "5x equity warnings" as a single line."""
    intel = intel or {}
    equity_changes = equity_changes or {}
    evidence = []

    def _record(rule_id, human, impact, value=None, unit=None,
                threshold=None):
        evidence.append({
            "rule_id": rule_id,
            "human_readable": human,
            "scenario_impact": dict(impact),
            "data_value": value,
            "data_unit": unit,
    ...
    if intel.get("malacca_severity") == "critical":
        _record(
            "malacca_critical_override",
            "Malacca severity flagged CRITICAL — matrix collapses "
            "to max Tail Risk; all other rules suppressed.",
            {"Tail Risk": +100, "Best Case": -5, "Base Case": -50,
             "Slow Normalization": -15},
            value="critical", unit="severity",
            threshold='malacca_severity == "critical"',
        )
        probs = {
            "Best Case": 0.0,
    ...
    if brent is not None and brent > 130:
        ...
        _record(
            "brent_critical",
            f"Brent at ${brent:.0f} (above $130 critical threshold)",
            {"Tail Risk": +10, "Base Case": -10},
            value=brent, unit="USD/bbl", threshold="Brent > $130",
        )
        ...
        _record(
            "brent_elevated",
            f"Brent at ${brent:.0f} (above $115 elevated threshold)",
            {"Tail Risk": +5, "Base Case": -5},
            value=brent, unit="USD/bbl", threshold="Brent > $115",
        )
        ...
        _record(
            "brent_easing",
            f"Brent at ${brent:.0f} (below $90 easing band)",
            {"Best Case": +5, "Tail Risk": -5},
            value=brent, unit="USD/bbl", threshold="Brent < $90",
        )
        ...
        _record(
            "brent_softening",
            f"Brent at ${brent:.0f} (below $95 softening band)",
            {"Best Case": +3, "Tail Risk": -3},
            value=brent, unit="USD/bbl", threshold="Brent < $95",
        )
    ...
    if ttf is not None and ttf > 80:
        ...
        _record(
            "ttf_critical",
            f"TTF at €{ttf:.0f} (above €80 critical threshold)",
            {"Tail Risk": +8, "Slow Normalization": -4,
             "Base Case": -4},
            value=ttf, unit="EUR/MWh", threshold="TTF > €80",
        )
        ...
        _record(
            "ttf_elevated",
            f"TTF at €{ttf:.0f} (above €65 elevated threshold)",
            {"Tail Risk": +4, "Base Case": -4},
            value=ttf, unit="EUR/MWh", threshold="TTF > €65",
        )
        ...
        _record(
            "ttf_easing",
            f"TTF at €{ttf:.0f} (below €50 easing — gas market relief)",
            {"Slow Normalization": +4, "Tail Risk": -4},
            value=ttf, unit="EUR/MWh", threshold="TTF < €50",
        )
    ...
    if urea is not None and urea > 800:
        ...
        _record(
            "urea_critical",
            f"Urea at ${urea:.0f}/t (above $800 critical threshold)",
            {"Tail Risk": +6, "Base Case": -4, "Best Case": -2},
            value=urea, unit="USD/tonne", threshold="Urea > $800/t",
        )
        ...
        _record(
            "urea_elevated",
            f"Urea at ${urea:.0f}/t (above $600 elevated threshold)",
            {"Tail Risk": +3, "Base Case": -3},
            value=urea, unit="USD/tonne", threshold="Urea > $600/t",
        )
        ...
        _record(
            "urea_easing",
            f"Urea at ${urea:.0f}/t (below $500 — fertiliser-cost "
            "pressure easing)",
            {"Slow Normalization": +4, "Tail Risk": -4},
            value=urea, unit="USD/tonne", threshold="Urea < $500/t",
        )
    ...
    if hormuz is not None and hormuz < 20:
        ...
        _record(
            "hormuz_critical",
            f"Hormuz at {hormuz:.0f} ships/day (below 20 — strait blocked)",
            {"Tail Risk": +12, "Base Case": -8, "Best Case": -4},
            value=hormuz, unit="ships/day",
            threshold="Hormuz < 20/day",
        )
        ...
        _record(
            "hormuz_elevated",
            f"Hormuz at {hormuz:.0f} ships/day (below 30 — transit "
            "stress)",
            {"Tail Risk": +5, "Base Case": +3, "Best Case": -4,
             "Slow Normalization": -4},
            value=hormuz, unit="ships/day",
            threshold="Hormuz < 30/day",
        )
        ...
        _record(
            "hormuz_recovering",
            f"Hormuz at {hormuz:.0f} ships/day (above 60 — recovering "
            "toward peace-time)",
            {"Best Case": +5, "Tail Risk": -5},
            value=hormuz, unit="ships/day",
            threshold="Hormuz > 60/day",
        )
    elif hormuz is not None and hormuz > 30:
        probs["Slow Normalization"] += 4
        probs["Tail Risk"] -= 4
        _record(
            "hormuz_easing",
            f"Hormuz at {hormuz:.0f} ships/day (above 30 — partial "
            "easing)",
            {"Slow Normalization": +4, "Tail Risk": -4},
            value=hormuz, unit="ships/day",
            threshold="Hormuz > 30/day",
    ...
    if panama is not None and panama > 4_000_000:
        ...
        _record(
            "panama_critical",
            f"Panama slot at ${panama:,.0f} (above $4M critical "
            "threshold)",
            {"Tail Risk": +5, "Base Case": -3, "Best Case": -2},
            value=panama, unit="USD/slot",
            threshold="Panama slot > $4M",
        )
        ...
        _record(
            "panama_elevated",
            f"Panama slot at ${panama:,.0f} (above $2.5M elevated)",
            {"Tail Risk": +2, "Base Case": -2},
            value=panama, unit="USD/slot",
            threshold="Panama slot > $2.5M",
        )

    # Malacca elevated (non-critical).
    if intel.get("malacca_severity") == "elevated":
        ...
        _record(
            "malacca_elevated",
            "Malacca severity ELEVATED — vessel backlog or breaking "
            "incident",
            {"Tail Risk": +8, "Base Case": -4,
             "Slow Normalization": -4},
            value="elevated", unit="severity",
            threshold='malacca_severity == "elevated"',
        )

    # Malacca shadow indicator.
    if (
        ...
        _record(
            "malacca_shadow",
            "Malacca shadow active — ships-waiting > 15% above 80/day "
            "baseline",
            {"Tail Risk": +6, "Base Case": +2, "Best Case": -4,
             "Slow Normalization": -4},
            value=intel.get("malacca_ships_waiting"),
            unit="ships waiting",
            threshold="ships_waiting > 80 × 1.15",
        )
    ...
    if helium is not None and helium > 2000:
        ...
        _record(
            "helium_critical",
            f"Helium spot at ${helium:,.0f}/Mcf (above $2,000 — "
            "structural shortage)",
            {"Tail Risk": +4, "Base Case": +4, "Best Case": -4,
             "Slow Normalization": -4},
            value=helium, unit="USD/Mcf",
            threshold="Helium > $2,000/Mcf",
        )
        ...
        _record(
            "helium_easing",
            f"Helium spot at ${helium:,.0f}/Mcf (below $1,000 — "
            "supply plausibly recovering)",
            {"Slow Normalization": +4, "Tail Risk": -4},
            value=helium, unit="USD/Mcf",
            threshold="Helium < $1,000/Mcf",
        )

    # Resin spike (computed at runtime from absolute PP price).
    ...
    if resin_spike is not None and resin_spike > 40:
        ...
        _record(
            "resin_spike",
            f"Asia PP spike at +{resin_spike:.0f}% (above 40% — "
            "petrochemical BOM stress)",
            {"Base Case": +5, "Best Case": -3,
             "Slow Normalization": -2},
            value=resin_spike, unit="percent above 2024 baseline",
            threshold="resin spike > 40%",
        )
        ...
        _record(
            "resin_easing",
            f"Asia PP spike at +{resin_spike:.0f}% (below 10% — "
            "BOM pressure easing)",
            {"Slow Normalization": +3, "Tail Risk": -3},
            value=resin_spike, unit="percent above 2024 baseline",
            threshold="resin spike < 10%",
        )
    ...
    if jet is not None and jet > 1500:
        ...
        _record(
            "jet_critical",
            f"Jet fuel at ${jet:,.0f}/t (above $1,500 — payload "
            "displacement)",
            {"Base Case": +4, "Best Case": -2,
             "Slow Normalization": -2},
            value=jet, unit="USD/tonne",
            threshold="Jet fuel > $1,500/t",
        )
        ...
        _record(
            "jet_easing",
            f"Jet fuel at ${jet:,.0f}/t (below $1,200 — aviation "
            "stress easing)",
            {"Slow Normalization": +3, "Tail Risk": -3},
            value=jet, unit="USD/tonne",
            threshold="Jet fuel < $1,200/t",
        )
    ...
    if intel.get("india_rice_ban_status") == "ACTIVE":
        ...
        _record(
            "india_rice_ban_active",
            "India rice export ban ACTIVE — sovereign food-policy "
            "shock",
            {"Tail Risk": +18, "Base Case": -8, "Best Case": -5,
             "Slow Normalization": -5},
            value="ACTIVE", unit="ban status",
            threshold='india_rice_ban_status == "ACTIVE"',
        )
    ...
    if helium_exhausted():
        ...
        _record(
            ...
            unit="days since QA force majeure",
            threshold="days_elapsed >= 48 AND live spot >= $400",
        )
    ...
    if OECD_INVENTORY_BREACH:
        ...
        _record(
            ...
            f"OECD commercial inventory below "
            f"{OECD_INVENTORY_OPERATIONAL_MIN_MB} MB operational "
            "minimum",
            {"Tail Risk": +8, "Base Case": -4,
             "Slow Normalization": -4},
            value=True, unit="below-minimum flag",
            threshold=f"OECD inv < "
                      f"{OECD_INVENTORY_OPERATIONAL_MIN_MB} MB",
        )
    ...
    if CO2_BYPRODUCT_BREACH:
        ...
        _record(
            ...
            f"(below {EUROPEAN_AMMONIA_THRESHOLD_PCT:.0f}% — food-grade "
            "CO2 production knocked out)",
            {"Tail Risk": +6, "Base Case": -3,
             "Slow Normalization": -3},
            value=EUROPEAN_AMMONIA_CAPACITY_PCT,
            unit="% capacity",
            threshold=f"EU ammonia < "
                      f"{EUROPEAN_AMMONIA_THRESHOLD_PCT:.0f}%",
        )

    # Jet payload-displacement gate (separate from absolute jet fuel).
    ...
    if jet_pct is not None and jet_pct > JET_FUEL_SPIKE_THRESHOLD_PCT:
        ...
        probs["Slow Normalization"] -= 2
        _record(
            "jet_payload_displacement",
            f"Jet fuel +{jet_pct:.0f}% above peace-time baseline "
            f"(above {JET_FUEL_SPIKE_THRESHOLD_PCT}% — payload "
            "displacement)",
            {"Base Case": +4, "Best Case": -2,
             "Slow Normalization": -2},
            value=jet_pct, unit="percent above baseline",
            threshold=f"jet spike > {JET_FUEL_SPIKE_THRESHOLD_PCT}%",
        )

    # Equity Proxy Radar — composite over all proxies.
    warning_count = 0
    critical_count = 0
    ...
    if warning_count > 0:
        ...
        _record(
            "equity_warnings_aggregate",
            f"{warning_count}× equity proxy WARNING tier "
            "(|daily move| ≥ 5%)",
            {"Base Case": +2 * warning_count,
             "Best Case": -1 * warning_count,
             "Slow Normalization": -1 * warning_count},
            value=warning_count, unit="proxies",
            threshold="|daily move| >= 5%",
        )
    ...
    if critical_count > 0:
        ...
        _record(
            "equity_criticals_aggregate",
            f"{critical_count}× equity proxy CRITICAL tier "
            "(|daily move| ≥ 12%)",
            {"Tail Risk": +8 * critical_count,
             "Base Case": -3 * critical_count,
             "Best Case": -3 * critical_count,
             "Slow Normalization": -2 * critical_count},
            value=critical_count, unit="proxies",
            threshold="|daily move| >= 12%",
        )
...
def explain_dominant_scenario(adjusted, evidence):
    """v18+ — produce the structured explanation for the
    "Why this scenario is leading" panel.

    Walks the evidence list, scores each rule by its contribution
    to the dominant scenario, and returns the top 5 supporting
    and top 3 opposing signals ranked by absolute impact."""
    if not adjusted:
        return None
    dominant = max(adjusted, key=adjusted.get)
    contributors = []
    for ev in evidence:
        impact = ev["scenario_impact"].get(dominant, 0)
        if impact != 0:
            contributors.append({**ev, "impact_on_dominant": impact})
    contributors.sort(
        key=lambda x: abs(x["impact_on_dominant"]), reverse=True,
    )
    top_supporting = [
        c for c in contributors if c["impact_on_dominant"] > 0
    ][:5]
    top_opposing = [
        c for c in contributors if c["impact_on_dominant"] < 0
    ][:3]
    net_lift = sum(c["impact_on_dominant"] for c in contributors)
    return {
        "dominant": dominant,
        "baseline_pct": BASE_PROBS.get(dominant, 0.0),
        "current_pct": adjusted.get(dominant, 0.0),
        "net_rule_contribution": net_lift,
...
def _render_horizon_cell_html(text):
    """Convert the cell's `**...**` markdown bold runs to
    `<strong>...</strong>` so the cell can be embedded inside an
    HTML container with no further markdown processing."""
    if not text:
        return ""
    return re.sub(r"\*\*([^*]+)\*\*", r"<strong>\1</strong>", text)


def build_scenario_horizon_grid_html(scenario_name, horizon_key):
    """v18+ — assemble the 10-row + footer HTML block for one
    scenario × horizon. Returns a single HTML string suitable for
    a single st.markdown(unsafe_allow_html=True) call. Cells are
    looked up verbatim from SCENARIO_HORIZON_PROJECTIONS; markdown
    bold is converted to <strong> at render time."""
    cells = (
        SCENARIO_HORIZON_PROJECTIONS.get(scenario_name, {}).get(
            horizon_key, {},
        )
    )
    footer = (
        SCENARIO_HORIZON_FOOTERS.get(scenario_name, {}).get(
            horizon_key, "",
        )
    )
    parts = ['<div class="horizon-grid">']
    for metric_key in SCENARIO_HORIZON_METRIC_ORDER:
        cell_text = cells.get(metric_key, "")
        cell_html = _render_horizon_cell_html(cell_text)
        color = SCENARIO_HORIZON_CLUSTER_COLORS.get(
            metric_key, "#9ca3af",
        )
        label = SCENARIO_HORIZON_METRIC_LABELS.get(
            metric_key, metric_key,
        )
        parts.append(
            f'<div class="horizon-row" '
            f'style="border-left-color:{color};">'
            f'<div class="horizon-row-label">{html.escape(label)}'
            f'</div>'
            f'<div class="horizon-row-cell">{cell_html}</div>'
            f'</div>'
        )
    parts.append(
        f'<div class="horizon-footer">'
        f'<span class="horizon-footer-tag">▸ What to do</span>'
        f'<div class="horizon-footer-body">'
        f'{_render_horizon_cell_html(footer)}'
        f'</div>'
        f'</div>'
    )
    parts.append('</div>')
...
def build_strategic_outlook_grid_dump(scenario_name, adjusted,
                                       second_scenario, contested):
    """v18+ — Source-Dump-friendly snapshot of the rendered grid
    for the dominant scenario. Returns a dict matching the spec
    in PART 5."""
    cells_per_horizon = {}
    for horizon_key, _label in SCENARIO_HORIZON_TAB_LABELS:
        h_cells = (
            SCENARIO_HORIZON_PROJECTIONS.get(
                scenario_name, {},
            ).get(horizon_key, {})
        )
        cells_per_horizon[horizon_key] = {
            mk: h_cells.get(mk, "")
            for mk in SCENARIO_HORIZON_METRIC_ORDER
        }
    footers = {
        horizon_key: (
            SCENARIO_HORIZON_FOOTERS.get(scenario_name, {}).get(
        ...
        for horizon_key, _ in SCENARIO_HORIZON_TAB_LABELS
    }
    targets = SCENARIO_PROJECTION_TARGETS.get(scenario_name, {})
    fact = EDITORIAL_FACTS.get(
        "scenario_horizon_projections_freshness", {},
    )
    set_on = fact.get("set_on")
    expires_on = fact.get("expires_on")
    return {
        "dominant_scenario": scenario_name,
        "probability": (
            adjusted.get(scenario_name) if adjusted else None
        ),
        "contested": bool(contested),
        "second_scenario": second_scenario,
        "second_probability": (
            adjusted.get(second_scenario)
            if (adjusted and second_scenario) else None
        ),
        "rendered_grid": cells_per_horizon,
        "footer_text": footers,
        "scenario_targets": dict(targets),
        "library_freshness": {
            "set_on": set_on.isoformat() if set_on else None,
            "expires_on":
                expires_on.isoformat() if expires_on else None,
            "is_current": is_scenario_library_fresh(),
        },
    }


@st.cache_data(ttl=14400)
def fetch_recent_projection_log(github_raw_url, limit=30):
    """v18+ Part 3e — pull the last `limit` rows from the public
    projection_log.csv. Cached on the same 4-hour TTL as the rest
    of the live feed so repeated reruns don't hammer GitHub.
    Returns a list of dicts (newest first), or [] when the log
    file isn't reachable yet (fresh deploy / no commits)."""
    try:
...
def _build_source_dump(prices, intel_data, intel_meta, editorial_log,
                       ...
                       grs_history=None,
                       strategic_outlook_grid=None,
                       dominant_scenario_evidence=None):
    ...
    v18+ Strategic Outlook —
      `strategic_outlook_grid` is the rendered cell snapshot for
      the dominant scenario (built via
      build_strategic_outlook_grid_dump).
      `dominant_scenario_evidence` is the full output of
      explain_dominant_scenario(), with all top_supporting and
      top_opposing records."""
    ...
    return {
        ...
        # v18+ — Strategic Outlook horizon-projection snapshot.
        # When the dominant scenario doesn't change between page
        # loads these blocks stay identical, so the auditor can
        # diff session-to-session and spot when the lead flips.
        "strategic_outlook_grid": strategic_outlook_grid,
        "dominant_scenario_evidence": dominant_scenario_evidence,
...
# v18+ — request the evidence list too so the Strategic Outlook
# "why is this scenario leading" panel can explain the verdict.
adjusted, _adjusted_evidence = adjust_probabilities(
    prices, intel_data, equity_changes, return_evidence=True,
)
...
# ---------- STRATEGIC OUTLOOK (v18+ horizon-projection grid) ----------
# Replaces the v11-era static four-bullet narrative. Lead scenario
# is whichever entry in `adjusted` carries the highest probability;
# the 4-tab grid below renders that scenario's 10 metric × 4
# horizon projection cells from SCENARIO_HORIZON_PROJECTIONS, each
# cell hand-authored as immutable editorial copy. The "what if
# next takes over?" expander shows the second-most-likely
# scenario's grid for contingency planning.
if not is_scenario_library_fresh():
    st.markdown(
        '<div class="calibration-drift-banner">'
        '⚠ The scenario projection library was last refreshed '
        'more than 90 days ago. Calibration may have drifted '
        '— the projections still display but should be '
        'reviewed before relying on them for planning.'
        '</div>',
        unsafe_allow_html=True,
    )
...
# Pick dominant + secondary scenarios.
_so_sorted = sorted(
    adjusted.items(), key=lambda x: x[1], reverse=True,
) if adjusted else []
_so_dominant = _so_sorted[0][0] if _so_sorted else None
_so_dominant_pct = _so_sorted[0][1] if _so_sorted else 0.0
_so_second = _so_sorted[1][0] if len(_so_sorted) > 1 else None
_so_second_pct = _so_sorted[1][1] if len(_so_sorted) > 1 else 0.0
_so_contested = (
    _so_dominant is not None and _so_second is not None
    and (_so_dominant_pct - _so_second_pct) < 10.0
)

# Lead-scenario header line.
_so_color = PROB_COLORS.get(_so_dominant, "#9ca3af")
if _so_dominant is not None:
    if _so_contested:
        _so_header = (
            f'<div class="lead-scenario-header">'
            f'<span class="lead-tag">LEAD SCENARIO</span>'
            f'<span class="lead-name" '
            f'style="color:{_so_color};">'
            f'{html.escape(_so_dominant.upper())}</span>'
            f'<span class="lead-prob">{_so_dominant_pct:.0f}%</span>'
            f'<span class="lead-contested">'
            f'· contested with {html.escape(_so_second.upper())} '
            f'({_so_dominant_pct:.0f}/{_so_second_pct:.0f})'
            f'</span>'
            f'</div>'
        )
    else:
    ...
    st.markdown(_so_header, unsafe_allow_html=True)

# Evidence panel: top supporting / opposing rules for dominant.
_so_explanation = explain_dominant_scenario(adjusted, _adjusted_evidence)
if _so_explanation is not None and _so_dominant is not None:
    _ev_supp = _so_explanation["top_supporting"]
    _ev_opp = _so_explanation["top_opposing"]
    _ev_title = (
        f"▸ Why {_so_dominant} is leading "
        f"({len(_ev_supp)} supporting / {len(_ev_opp)} opposing signals)"
    )
    with st.expander(_ev_title, expanded=False):
        st.markdown(
            f'<div class="evidence-panel-summary">'
            f'<strong>Baseline weight:</strong> '
            f'{_so_explanation["baseline_pct"]:.0f}% (BASE_PROBS)'
            f' &nbsp;·&nbsp; '
            f'<strong>Current weight:</strong> '
            f'{_so_explanation["current_pct"]:.1f}% (live data adjusted)'
            f' &nbsp;·&nbsp; '
            f'<strong>Net rule lift:</strong> '
            f'{_so_explanation["net_rule_contribution"]:+d} points '
            f'from {len(_ev_supp) + len(_ev_opp)} active rules'
            f'</div>',
            unsafe_allow_html=True,
        )
        if _ev_supp:
            st.markdown(
                '<div style="font-size:0.7rem;letter-spacing:1.5px;'
                'color:#fca5a5;text-transform:uppercase;'
                'font-family:Courier New,monospace;'
                'margin:0.5rem 0 0.3rem 0;">'
                'TOP SUPPORTING SIGNALS</div>',
                unsafe_allow_html=True,
            )
            for ev in _ev_supp:
                st.markdown(
                    f'<div class="evidence-panel-row ev-supporting">'
                    f'<span class="ev-glyph">▲</span>'
                    f'{html.escape(ev["human_readable"])} '
                    f'→ <strong>+{ev["impact_on_dominant"]}</strong> '
                    f'to {html.escape(_so_dominant)}'
                    f'</div>',
                    unsafe_allow_html=True,
                )
        if _ev_opp:
            st.markdown(
                ...
                'COUNTERVAILING SIGNALS</div>',
                unsafe_allow_html=True,
            )
            for ev in _ev_opp:
                st.markdown(
                    f'<div class="evidence-panel-row ev-opposing">'
                    f'<span class="ev-glyph">▼</span>'
                    f'{html.escape(ev["human_readable"])} '
                    f'→ <strong>{ev["impact_on_dominant"]}</strong> '
                    f'to {html.escape(_so_dominant)}'
        ...
        if not _ev_supp and not _ev_opp:
            st.markdown(
                "_No active rules are touching the dominant "
                "scenario — the matrix sits at its BASE_PROBS "
                "starting weights._"
            )

# Dominant scenario × 4 horizon tabs.
if _so_dominant is not None:
    _tabs = st.tabs([lbl for _, lbl in SCENARIO_HORIZON_TAB_LABELS])
    for _tab, (_h_key, _h_label) in zip(
        _tabs, SCENARIO_HORIZON_TAB_LABELS,
    ):
        with _tab:
            st.markdown(
                build_scenario_horizon_grid_html(
                    _so_dominant, _h_key,
                ),
                unsafe_allow_html=True,
            )

# Secondary scenario expander.
if _so_second is not None:
    with st.expander(
        f"▸ What if {_so_second} takes over? "
        f"(currently {_so_second_pct:.0f}%)",
        expanded=False,
    ):
        _alt_tabs = st.tabs(
            [lbl for _, lbl in SCENARIO_HORIZON_TAB_LABELS],
        )
        for _alt_tab, (_h_key, _h_label) in zip(
            _alt_tabs, SCENARIO_HORIZON_TAB_LABELS,
        ):
            with _alt_tab:
                st.markdown(
                    build_scenario_horizon_grid_html(
...
with st.expander(
    ...
    _log_rows = fetch_recent_projection_log(_PROJECTION_LOG_RAW_URL)
    if not _log_rows:
        st.markdown(
            "_No projection log entries available yet. "
            "The GitHub Actions workflow appends one row per day "
            "to `projection_log.csv`; new dashboards may have an "
            "empty log until the first scheduled run completes._"
        )
    else:
        for _r in _log_rows:
            _date = _r.get("date", "?")
            _grs = _r.get("grs_overall", "?")
            _lead = _r.get("dominant_scenario", "?")
            _lead_prob = (
                _r.get("prob_tail")
                if _lead == "Tail Risk"
                else _r.get("prob_base")
                if _lead == "Base Case"
                else _r.get("prob_slow")
                if _lead == "Slow Normalization"
                else _r.get("prob_best")
                if _lead == "Best Case"
                else "?"
            )
            st.markdown(
                f'<div class="projection-log-row">'
                f'{html.escape(_date)} · GRS {html.escape(str(_grs))}% '
                f'· Lead {html.escape(str(_lead))} '
                f'({html.escape(str(_lead_prob))}%)</div>',
                unsafe_allow_html=True,
            )
...
with col2:
    ...
    if _he_tier is not None:
        ...
        intel_cards.append(card_status_html(
            ...
            "helium prices at $800/Mcf — roughly 2.6× pre-war "
            "baseline. Linde and Air Products signing new long-"
            "term agreements with Samsung / SK Hynix — note this "
...
with st.expander(
    ...
    # v18+ Strategic Outlook — pre-build the grid snapshot and
    # evidence block so the source dump captures exactly what the
    # operator sees on the page. `_so_dominant` / `_so_second` /
    # `_so_contested` / `_so_explanation` were assigned earlier in
    # the Strategic Outlook render block.
    _strategic_outlook_grid = (
        build_strategic_outlook_grid_dump(
            _so_dominant, adjusted, _so_second, _so_contested,
        )
        if _so_dominant is not None else None
    )
    _src_dump = _build_source_dump(
        ...
        # v18+ Strategic Outlook horizon snapshot.
        strategic_outlook_grid=_strategic_outlook_grid,
        dominant_scenario_evidence=_so_explanation,
    )
